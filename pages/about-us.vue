<template>
  <div>
    <div class="py-6 bg-white sm:py-8 lg:py-12">
      <div class="max-w-screen-lg px-4 mx-auto md:px-8">
        ...
        <p class="mb-6 text-gray-500 sm:text-lg md:mb-8">
          ...
          text. The important factor when using filler text is that the text looks realistic otherwise it will not look
          very good.<br /><br />

          This is a section of some simple filler text, also known as placeholder text. It shares some characteristics
          of a real written text but is <a href="#"
            class="text-indigo-500 underline transition duration-100 hover:text-indigo-600 active:text-indigo-700">random</a>
          or otherwise generated. It may be used to display a sample of fonts or generate text for testing. Filler text
        ...
        <div class="relative mb-6 overflow-hidden bg-gray-100 rounded-lg shadow-lg md:mb-8">
          <img src="https://justfields.com/storage/projects/7M5rV059/200.jpg" loading="lazy"
    ...
    <div class="py-6 bg-white sm:py-8 lg:py-12">
      <div class="max-w-screen-lg px-4 mx-auto md:px-8">
        <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
          <div>
            <div class="h-64 overflow-hidden bg-gray-100 rounded-lg shadow-lg md:h-auto">
              <img src="https://justfields.com/storage/projects/7M5rV059/100.jpg" loading="lazy"
                class="object-cover object-center w-full h-full" />
            </div>
          </div>
    ...
    <section class="relative px-6 py-12 overflow-hidden lg:px-8">
      <div
